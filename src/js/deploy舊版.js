...
// ------------------------------------------------------------------------------------
const deployPage = (bookmarkName, setPageZIndex, setContainerPositionTop, setContainerWidth, setContainerPositionLeft) => {
    ...
    let [topChange, leftChange, widthChange] =
        bookmarkName === "mina" ? [1, 0, 1,] :
            bookmarkName === "gallery" ? [1, 0.25, 1] :
                bookmarkName === "wolfy" ? [1, 0.5, 1] :
                    bookmarkName === "show" ? [1, 0.75, 1] :
                        bookmarkName === "luna" ? [1, 1, 1] : undefined;
