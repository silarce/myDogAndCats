...
function PhotoQueue({ imgArr, location, cssTranslateY, cssTranslateX, cssTransition }) {
    console.log(cssTransition)

    return (
        <ThePhotoQueue location={location} cssTranslateY={cssTranslateY} cssTranslateX={cssTranslateX} cssTransition={cssTransition}>
            <QueueItem queueNumber={-25} src={imgArr[0]} ></QueueItem>
            <QueueItem queueNumber={0} src={imgArr[1]} ></QueueItem>
            <QueueItem queueNumber={25} src={imgArr[2]} ></QueueItem>
            <QueueItem queueNumber={50} src={imgArr[3]} ></QueueItem>
            <QueueItem queueNumber={75} src={imgArr[4]} ></QueueItem>
